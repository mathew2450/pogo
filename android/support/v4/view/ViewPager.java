...
public class ViewPager extends ViewGroup {
    ...
    static class C00791 implements Comparator<ItemInfo> {
        C00791() {
        }
    ...
    static class C00802 implements Interpolator {
        C00802() {
        }
    ...
    class MyAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (ViewPager.this.canScrollHorizontally(ViewPager.SCROLL_STATE_DRAGGING)) {
                info.addAction((int) AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD);
            }
    ...
    public static class SavedState extends BaseSavedState {
        ...
        static class C00821 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C00821() {
            }
        ...
        static {
            CREATOR = ParcelableCompat.newCreator(new C00821());
        }
    ...
    static {
        ...
        LAYOUT_ATTRS = iArr;
        COMPARATOR = new C00791();
        sInterpolator = new C00802();
    ...
    public ViewPager(Context context) {
        ...
        this.mEndScrollRunnable = new C00813();
