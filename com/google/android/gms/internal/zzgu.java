    ...
    public static AdResponseParcel zza(Context context, AdRequestInfoParcel adRequestInfoParcel, String str) {
        try {
            ...
            if (TextUtils.isEmpty(optString5)) {
                ...
                AdResponseParcel zza = zzgt.zza(adRequestInfoParcel, context, adRequestInfoParcel.zzqj.zzJu, optString3, null, null, null, null, null);
                optString2 = zza.zzBF;
                str2 = zza.body;
                j2 = zza.zzEO;
            ...
            if (adResponseParcel != null) {
                ...
                if (adResponseParcel.zzEJ > 0) {
                    ...
                    return new AdResponseParcel(adRequestInfoParcel, optString2, str2, list, list2, j, jSONObject.optBoolean("mediation", false), jSONObject.optLong("mediation_config_cache_time_milliseconds", -1), list3, jSONObject.optLong("refresh_interval_milliseconds", -1), i2, optString4, j2, optString6, optBoolean, str3, optString, jSONObject.optBoolean("custom_render_allowed", false), z, adRequestInfoParcel.zzEv, jSONObject.optBoolean("content_url_opted_out", true), jSONObject.optBoolean("prefetch", false), jSONObject.optInt("oauth2_token_status", 0), jSONObject.optString("gws_query_id", BuildConfig.FLAVOR), "height".equals(jSONObject.optString("fluid", BuildConfig.FLAVOR)));
                }
            }
            j = j3;
            optString = jSONObject.optString("active_view");
