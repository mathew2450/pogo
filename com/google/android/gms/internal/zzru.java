...
public final class zzru extends zzry<zzru> {
    ...
    public boolean equals(Object o) {
        ...
        if (this.zzbik == null || this.zzbik.isEmpty()) {
            return com_google_android_gms_internal_zzru.zzbik == null || com_google_android_gms_internal_zzru.zzbik.isEmpty();
        } else {
    ...
    public int hashCode() {
        int hashCode = (((((((getClass().getName().hashCode() + 527) * 31) + zzsc.hashCode(this.zzbhU)) * 31) + zzsc.hashCode(this.zzbhV)) * 31) + zzsc.zza(this.zzbhW)) * 31;
    ...
    protected int zzB() {
        ...
        i2 = 0;
        i3 = 0;
        while (i4 < this.zzbhW.length) {
            byte[] bArr = this.zzbhW[i4];
            if (bArr != null) {
                i3++;
                i2 += zzrx.zzE(bArr);
            }
