...
public final class zzsa implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        zzsa com_google_android_gms_internal_zzsa = (zzsa) o;
        if (size() != com_google_android_gms_internal_zzsa.size()) {
            return false;
        }
        return zza(this.zzbip, com_google_android_gms_internal_zzsa.zzbip, this.mSize) && zza(this.zzbiq, com_google_android_gms_internal_zzsa.zzbiq, this.mSize);
    }
