...
class zzsb implements Cloneable {
    ...
    public boolean equals(Object o) {
        ...
        zzsb com_google_android_gms_internal_zzsb = (zzsb) o;
        ...
        } else if (this.zzbir != com_google_android_gms_internal_zzsb.zzbir) {
            return false;
        } else {
            if (!this.zzbir.zzbil.isArray()) {
                return this.zzbis.equals(com_google_android_gms_internal_zzsb.zzbis);
            }
            if (this.zzbis instanceof byte[]) {
                return Arrays.equals((byte[]) this.zzbis, (byte[]) com_google_android_gms_internal_zzsb.zzbis);
            }
            if (this.zzbis instanceof int[]) {
                return Arrays.equals((int[]) this.zzbis, (int[]) com_google_android_gms_internal_zzsb.zzbis);
            }
            if (this.zzbis instanceof long[]) {
                return Arrays.equals((long[]) this.zzbis, (long[]) com_google_android_gms_internal_zzsb.zzbis);
            }
            if (this.zzbis instanceof float[]) {
                return Arrays.equals((float[]) this.zzbis, (float[]) com_google_android_gms_internal_zzsb.zzbis);
            }
            if (this.zzbis instanceof double[]) {
                return Arrays.equals((double[]) this.zzbis, (double[]) com_google_android_gms_internal_zzsb.zzbis);
            }
            return this.zzbis instanceof boolean[] ? Arrays.equals((boolean[]) this.zzbis, (boolean[]) com_google_android_gms_internal_zzsb.zzbis) : Arrays.deepEquals((Object[]) this.zzbis, (Object[]) com_google_android_gms_internal_zzsb.zzbis);
        }
    }
